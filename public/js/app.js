...
window.onload = function () {
  ...
  var filterImg = document.querySelectorAll(".gallery_link");
  filterImg.forEach(function (image) {
    var filterImges = image.getAttribute("data-name"); //getting image data-name value
  ...
  for (var i = 0; i < a.length; i++) {
    a[i].addEventListener("click", function () {
      for (var _i = 0; _i < a.length; _i++) {
        a[_i].parentNode.classList.remove("active");
      }

      this.parentNode.classList.toggle("active");
      var filterName = this.parentNode.getAttribute("data-name");
      filterImg.forEach(function (image) {
        var filterImges = image.getAttribute("data-name"); //getting image data-name value
        //if user selected item data-name value is equal to images data-name value
        //or user selected item data-name value is equal to "all"
...
var images = document.querySelectorAll(".gallery_link");
...
images.forEach(function (btn) {
  btn.addEventListener("click", function () {
    ...
    axios.get("/post_details/" + id).then(function (response) {
      document.getElementById("modal-title").innerHTML = response.data.title;
      document.getElementById("modal-desc").innerHTML = response.data.description; // console.log(11);

      document.getElementById("catalog-modal").href = response.data.catalog;
      document.getElementById("catalog-modal").href = "/catalog" + "/" + response.data.catalog;
      document.getElementById("catalog-modal").innerHTML = response.data.catalog;
      document.getElementById("bucklet-modal").href = "/bucklet" + "/" + response.data.bucklet;
      document.getElementById("bucklet-modal").innerHTML = response.data.bucklet;
    ...
    var pdftButtons = document.getElementsByClassName("pdf");
    var pdfFille = document.querySelectorAll(".contactus .quick-panel");

    for (var i = 0; i < pdftButtons.length; i++) {
      pdftButtons[i].addEventListener("click", function () {
        for (var _i2 = 0; _i2 < pdftButtons.length; _i2++) {
          pdftButtons[_i2].classList.remove("red");
        }

        this.classList.toggle("red");
        var filterpdf = this.getAttribute("data-name");
        pdfFille.forEach(function (a) {
